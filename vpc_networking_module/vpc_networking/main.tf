...
resource "aws_instance" "mymodule-ec2" {
 ...
 # user_data = "" # implement your own user data at startup if needed
}
...
#step 9: provide variables and execute terraform
#extracting key pair and instance type to higher level (module level for reusability)
